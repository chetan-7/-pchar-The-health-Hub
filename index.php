            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <p class="bounceInLeft" id="b1">#Need to write here</p>
            ...
            <div class="row">
                 <div class="col-md-3 col-sm-6 vd">
                    <div class="bkjiu">
                     ...
                     <button class="btn btn-sm btn-danger"><a href="bloodonateform.html">Readmore</a> <i class="fas fa-arrow-right"></i></button>
                     </div>
                 </div>
                 <div class="col-md-3 col-sm-6 vd">
                    <div class="bkjiu">
